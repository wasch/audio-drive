...
const Playlist = (props) => {
    ...
    return (
        <div>
            <div className="flex flex-col md:flex-row flex-grow items-center mb-6">
                <div className="w-full overflow-scroll">
                    <h3 className="text-4xl py-1">{name}</h3>
                </div>
                <div className="flex flex-row items-center md:ml-auto mt-6 md:mt-auto">
                    ...
                    <button className="flex border-2 rounded-sm border-zinc-500 ml-2 md:ml-5 p-1 hover:cursor-pointer" title="Back" onClick={handleBack}>
